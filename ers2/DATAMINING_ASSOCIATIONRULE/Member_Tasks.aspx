  ...
  <!-- Breadcrumb Section Begin -->
   ...
   <!-- Register Section Begin -->
    ...
    <br />       
          ...
          <img src="../images/104.cms.jpg" width="300" height="180" alt="" /> &nbsp
         <img src="../images/101.cms.jpeg" width="300" height="180" alt="" /> &nbsp
          </marquee>
    ...
    <div class="breacrumb-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <h2><span>Member</span> Change Password</h2>
                    </div>
                </div>
            </div>
        </div>
   ...
   <!-- Register Section Begin -->
    ...
    <br />       
                    ...
                    <table style="width: 39%;">
                        <tr>
                            <td style="background-image: url('images/Changepassword_Frame.JPG'); height: 210px;" 
                                valign="middle">
