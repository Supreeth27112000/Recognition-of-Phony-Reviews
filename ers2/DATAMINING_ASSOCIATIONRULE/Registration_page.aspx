            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        <h2><span>Registration Form for</span> New Users</h2>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; font-size: small;">
                                <asp:CompareValidator ID="CompareValidator4" runat="server" 
                                    ...
                                    ValidationGroup="registration" ValueToCompare="Select">Select Martial Status</asp:CompareValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left; width: 140px; font-size: small;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left; font-size: small;">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
                                    ...
                                    ValidationGroup="registration">Enter City</asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: left; width: 140px; font-size: small;">
